...
#define  NOP 12                                    /*кол-во обрабатываемых   */
						  /* команд                 */
#define PRINT(...) do { fprintf(log_file, __VA_ARGS__); fflush (log_file); } while (0)
...
unsigned char INST [6];                           /*массив, содерж. обрабат.*/
						  /*команду                 */
int B1, D1, B2, D2, L, CR = 0;
FILE* log_file = NULL;

/*..........................................................................*/
						  /*п р о т о т и п  обращ.к*/
int FRR(void);                                        /*подпр.обр.опер.RR-форм. */

/*..........................................................................*/

						  /*п р о т о т и п  обращ.к*/
int FRX(void);                                        /*подпр.обр.опер.RX-форм. */
/*..........................................................................*/
...
int P_S()                                         /* п р о г р а м м а      */
 ...
 int P_CR()
 {
     PRINT("CR - change addr - %0lX %ld %ld\n", ADDR, VR[R1], VR[R2]);
 ...
 int P_CVB()
 {
     ...
     PRINT("CVB - change addr - %0lX\n", ADDR);
     
     ADDR = VR[B] + VR[X] + D;
     sm = ( int ) ( ADDR - I );
     
     PRINT("CVB - change addr - %0lX %lu\n", ADDR, VR[X] + D);
...
//     }
 ...
 int P_BC()
 {
    ...
    PRINT("BC - change addr - %0lX, CR = %d, cond = %d, instr = %d, ind = %d\n", ADDR, CR, R1, R2, CUR_IND);
    switch (R1)
    {
        case 8: 
        case 15:
    ...
    PRINT("BC - change addr - %0lX, CR = %d, cond = %d\n", ADDR, CR, R1);
    return 0;
 }
 
 int P_STH()
 {
    PRINT("STH - change addr - %0lX\n", ADDR);
    int sm,i;                                       
    char bytes[2];                                  
...
SKIP:
   ...
   {                                              //селектируемой сч.адреса 
    ...
    case 0x50 : P_ST();	         break;
    case 0x58 : P_L();           break;
    case 0x5A : P_A();           break;
    case 0x5B : P_S();           break;
    case 0x19 : P_CR();          break;
    case 0x4F : P_CVB();         break;
    case 0x48 : P_LH();          break;
    case 0x47 : P_BC();          break;
    case 0x40 : P_STH();         break;
    case 0xD2 : P_MVC(); 
             /*   I += 4;                        
                CUR_IND = ( int ) ( I - BAS_ADDR ); */
                break;
...
//main programm
  ...
  if (!(log_file = fopen ("absloadm.log", "w")))
  {
     return -1;
  }
