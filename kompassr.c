...
#define NSYM 512                                   /*размер табл.символов    */
	...
	)                                         /* то                     */
	{
             ...
             )                                         /* то                     */
        {
                 ...
                 )                                         /* то                     */
            {
                ...
                RAB=strtok((char*)TEK_ISX_KARTA.STRUCT_BUFCARD.OPERAND+3,"'");
                RX.OP_RX.B2D2 = atoi ( RAB );     /*перевод ASCII-> int     */
                RAB = (char *) &RX.OP_RX.B2D2;    /*приведение к соглашениям*/
                swab ( RAB, RAB, 2 );             /* ЕС ЭВМ                 */
            }
...
int SXX()                                         /*подпр.обр.опер.RX-форм. */
{
    char *METKA;                              /*набор                   */
    char *METKA1;                             /*рабочих                 */
    char *METKA2;                             /*переменных              */
    ...
    unsigned char R1X2;                       /*                        */
    int B2D2;                                 /*                        */
    XX.OP_XX.OP = T_MOP[I3].CODOP;            /*формирование кода операц*/
    METKA1 = strtok                           /*в перем. c указат.METKA1*/
    (                  /*выбираем первую лексему */
     (char*) TEK_ISX_KARTA.STRUCT_BUFCARD.OPERAND, /*операнда текущей карты  */
     ","                /*исх.текста АССЕМБЛЕРА   */
    ...
    {                                         /*с буквы, то:            */
        ...
        {                                 /* табл. T_SYM сравниваем */
            ...
            {                         /*  установить нач.знач.: */
                ...
                goto SXX1;  /*перех.на форм.первого   */
            }                         /*  опреранда машинной ком*/
        }
        printf("Ошибка: %s\n",METKA1);
        return(2);                        /*сообщ."необ'явл.идентиф"*/
    ...
    {                                         /*с буквы, то:            */
        ...
        {                                 /* табл. T_SYM сравниваем */
            ...
            {                         /*  установить нач.знач.: */
                ...
                goto SXX2;  /*перех.на форм.первого   */
            }                         /*  опреранда машинной ком*/
        }
        printf("Ошибка: %s\n",METKA2);
        return(2);                        /*сообщ."необ'явл.идентиф"*/
...
SXX2:
    ...
    printf("%s:\n",T_MOP[I3].MNCOP);
    printf("\t%s = 0x%x\n",METKA1,XX.OP_XX.B1D1);
    printf("\t%s = 0x%x\n",METKA2,XX.OP_XX.B2D2);
    return(0);                                /*выйти из подпрограммы   */
}
/*..........................................................................*/
